...
int main()
{
	OptimazedArrayList<student> arr;


	arr.add(new student("r", "c", 2));
	
	arr.add(new student("r", "c", 22133));
	arr.add(new student("r", "c", 55));
	arr.add(new student("r", "c", 4));
	arr.add(new student("r", "c", 1));
	arr.add(new student("r", "c", 0));
	arr.add(new student("r", "c", 22));
	arr.add(student("non e'", "un puntatore", 20));

	arr.remove(0);


	arr.printList(getStudentToString);
}